        ...
        child: Column(children: [
          Consumer<OrderDetailsController>(
            builder: (context, orderDetailsController, _) {
              bool paymentActive = orderDetailsController.orderDetails != null ? widget.orderModel!.paymentMethod == 'cash_on_delivery' ? (widget.orderModel!.paymentMethod == 'cash_on_delivery' && orderDetailsController.orderDetails![0].deliveryStatus == 'delivered') : true : false;
