            ...
            child: Consumer<CartController>(
              builder: (context, cartController, _) {
                if(cartController.invoice != null &&  cartController.invoice!.orderAmount != null){
                  ...
                  extraDiscountAmount = double.parse(PriceConverter.discountCalculationWithOutSymbol(context, cartController.invoice!.orderAmount!, cartController.invoice!.extraDiscount!, cartController.invoice!.extraDiscountType)) ;

                  totalPayableAmount = cartController.invoice!.orderAmount! +
                      cartController.totalTaxAmount - cartController.discountOnProduct - extraDiscountAmount - cartController.invoice!.discountAmount!;
                }
                        ...
                        child: Column(children: [
                          ...
                          Column(children: [
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,children: [
                              ...
                              Text(' - ${PriceConverter.discountCalculationWithOutSymbol(context, cartController.invoice!.orderAmount!, cartController.invoice!.extraDiscount!, cartController.invoice!.extraDiscountType)}'),
                            ],),
                            const SizedBox(height: Dimensions.paddingSizeSmall),
